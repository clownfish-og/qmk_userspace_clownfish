...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [AP] = LAYOUT_iso(AFTERNOON_PROJECT,
           KC_MUTE),

    [AB] = LAYOUT_iso(AFTERNOON_BRIGHTNESS,
           KC_MUTE),

    [MN] = LAYOUT_iso(MORNING,
           KC_MUTE),
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [AP] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [AB] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [MN] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
};
#endif
